...
import '/components/sports_drawer_widget.dart';
                    ...
                    children: [
                      ...
                      StreamBuilder<List<SportsRecord>>(
                        stream: querySportsRecord(
                          queryBuilder: (sportsRecord) =>
                              sportsRecord.orderBy('title'),
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<SportsRecord> listViewSportsRecordList =
                              snapshot.data!;
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Visibility(
                                visible: functions.showSearchResult(
                                        ...
                                        listViewSportsRecord.title)! ||
                                    functions.searchList(
                                        _model.textController.text,
                                        listViewSportsRecord.body.toList()),
                                child: Align(
                                  alignment: const AlignmentDirectional(0.0, -1.0),
                                  child: InkWell(
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child: SportsDrawerWidget(
                                                ref: listViewSportsRecord
                                                    .reference,
                                              ),
                                            ),
                                          );
