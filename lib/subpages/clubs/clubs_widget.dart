                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PagedListView<DocumentSnapshot<Object?>?,
                          ClubsRecord>.separated(
                        pagingController: _model.setListViewController(
                          ClubsRecord.collection.orderBy('title'),
                        ),
                          ...
                          itemBuilder: (context, _, listViewIndex) {
                            ...
                            return Visibility(
                              visible: functions.searchList(
                                      ...
                                      listViewClubsRecord.body.toList()) ||
                                  functions.showSearchResult(
                                      _model.textController.text,
                                      listViewClubsRecord.title)!,
                              child: Align(
                                alignment: const AlignmentDirectional(0.0, -1.0),
                                child: InkWell(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: OctoImage(
                                              ...
                                              image: CachedNetworkImageProvider(
                                                listViewClubsRecord.coverImage,
                                              ),
                                              width: 150.0,
                                              height: 125.0,
                                              fit: BoxFit.cover,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  listViewClubsRecord.body.first
                                                      .maybeHandleOverflow(
                                                    maxChars: 100,
                                                    replacement: '…',
                                                  ),
