...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE36D00);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF373737);
  late Color alternate = const Color(0xFFFFE3CA);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x40E36D00);
  late Color accent2 = const Color(0x40FFAB5E);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFFFAB5E);
