...
import 'business_drawer_model.dart';
export 'business_drawer_model.dart';
...
class _BusinessDrawerWidgetState extends State<BusinessDrawerWidget> {
  late BusinessDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessDrawerModel());
  }
                  ...
                  children: [
                    Align(
                      ...
                      child: StreamBuilder<BusinessesRecord>(
                        stream: BusinessesRecord.getDocument(widget.ref!),
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (columnBusinessesRecord.link !=
                                                    '')
                                              Padding(
